...
namespace NRKernal.NRExamples
{
    public class VideoRecordConfigPanel : MonoBehaviour
    {
        ...
        List<string> _ResolutionOptions = new List<string>() {
            VideoCapture2LocalExample.ResolutionLevel.High_1920p.ToString(),
            VideoCapture2LocalExample.ResolutionLevel.Default_1280p.ToString(),
            VideoCapture2LocalExample.ResolutionLevel.Low_640p.ToString()
        };
